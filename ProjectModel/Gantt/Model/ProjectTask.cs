  ...
  public  class ProjectTask : INotifyPropertyChanged 
    {
        ...
        public List<int> Lag { get; set; }
        public ObservableCollection<ProjectTask> Predecessors { get; set; }
        ...
        public ProjectTask()
        {
            Predecessors = new ObservableCollection<ProjectTask>();
        ...
        private void Predecessor_CollectionChanged(object sender, System.Collections.Specialized.NotifyCollectionChangedEventArgs e)
        {
            ...
            {
                Predecessors[i].Successors.Add(this);
            }
        }
        ...
        public void AddPredecessor(ProjectTask Predecessor)
        {
            Lag.Add(ij);
